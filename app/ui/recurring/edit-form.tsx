...
export default async function EditRecurringTransactionForm({
    ...
    const formatted = formatRecurringTransaction(recurringTransaction);
    const updateRecurringTransactionWithId = updateRecurringTransaction.bind(
        null,
        recurringTransaction.id
    );

    return (
        <form action={updateRecurringTransactionWithId}>
                ...
                <div className="mb-4">
                    ...
                    <div className="relative">
                        <select
                            ...
                            defaultValue={formatted.frequency}
                            required
                        >
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                ...
                                type="date"
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 pr-2 text-sm outline-2 placeholder:text-gray-500"
                                defaultValue={formatted.start_date}
                                required
                            />
                    ...
                    <div className="relative mt-2 rounded-md">
                        <div className="relative">
                            <input
                                ...
                                type="date"
                                className="peer block w-full rounded-md border border-gray-200 py-2 pl-10 pr-2 text-sm outline-2 placeholder:text-gray-500"
                                defaultValue={formatted.end_date || ""}
                            />
                            <CalendarDateRangeIcon className="pointer-events-none absolute left-3 top-1/2 h-[18px] w-[18px] -translate-y-1/2 text-gray-500 peer-focus:text-gray-900" />
                        </div>
                    </div>
